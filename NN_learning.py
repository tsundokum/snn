...
# Create structure to store theta matrixes
...
for epoch in range(epochs_count):  # Beginning of epoch loop
    ...
    for batch in range(batches_count):  # Beginning of batch loop
        ...
        # Save weights values
        theta_history[epoch * batches_count + batch + 1] = [theta_1_temp,
                                                            theta_2_temp,
                                                            theta_relation_temp]
...
# Compute final error after all loops of learning
